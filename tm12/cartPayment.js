...
let onTambah = (index) => {
    ...
    //untuk mengecek apakah ada data product yang sama di kerangjang dengan yang mau kita beli
    let ada = null
    cart.forEach(item => {
    ...
    //untuk kurangi stok produk jika dibeli
...
let onPayment = () => {
    ...
    res += `<b>Sub Total : Rp ${totalPrice + totalPrice/ 10} </b>`
    div.innerHTML = res
